...
#                      入力                      #
##################################################
# だいたい秋田県能代宇宙広場 (ゴール地点の例)
# 緯度経度をWGS84楕円体に基づいて設定
goal_lat, goal_lon = 40.14279008095458, 139.98748176625907
    ...
    while True:
        ...
        # --------------------------- #
            ...
            try:
                ...
                print(f"An error occured in phase 1: {e}")
                make_csv.print('error', f"An error occured in phase 1: {e}")
